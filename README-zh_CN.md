...
| 有序列表 (十进制数字) | 独立层级 | 分层拼接 | 无序列表 (使用 `H1 H2 H3 H4 H5 H6`) |
| :---------------: | :-----: | :----: | :-------------------------------: |
| ![有序列表](images/ordered.jpg) | ![独立层级](images/independent.jpg) | ![分层拼接](images/splice.jpg) | ![无序列表](images/unordered.jpg) |
...
在将装饰器的模式设置为有序列表、独立层级或分层拼接时，您可以控制标题的渲染逻辑，用于调整渲染结果或者忽略掉不想处理的标题级别。
