...
- **裝飾器的模式**：切換此設定可將標題裝飾為有序列表、獨立層級或無序列表列表。
...
| 有序列表 (十進位制數字) | 獨立層級 | 無序列表 (使用 `H1 H2 H3 H4 H5 H6`) |
| :---------------: | :------: | :-------------------------------: |
| ![有序列表](images/ordered.jpg) | ![獨立層級](images/independent.jpg) | ![無序列表](images/unordered.jpg) |
...
在將裝飾器的模式設定為有序列表或獨立層級時，您可以控制標題的渲染邏輯，用於調整渲染結果或者忽略掉不想處理的標題級別。
